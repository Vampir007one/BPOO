...
<head>
    ...
    <!--  -->
    <title>Локальные документы</title>
</head>
<body>
<header>
...
<div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 main__title">
                <p class="title__main tittle__abiturient">Локальные документы</p>
            </div>
            <div class="col-md-2 main__docsMenu">
                <ul>
                    <li><a href="docs.php">Документы</a></li>
                    <li><a href="local_docs.php" class="menu__activeLinkDocs">Локальные документы</li>
            ...
            <div class="col-md-10 main__docs ">
                ...
                <div class="docs__doc doc__small">
                    <div class="doc__info">
                        ...
                        <p class="doc__link"><a href="">Положение о Ресурсном центре</a></p>
                    </div>
                </div>
                <!-- doc1 -->
                <!-- doc2 -->
                <div class="docs__doc doc__small">
                    <div class="doc__info">
                        <img src="assets/img/pdfIcon.png" alt="" class="doc__logo">
                        <p class="doc__link"><a href="/assets/docs/Polozenie_o_BPOO.pdf">Положение о БПОО</a></p>
                    </div>
                </div>
                <!-- doc2 -->
                <!-- doc3 -->
                <div class="docs__doc doc__small">
                    <div class="doc__info">
                        <img src="assets/img/pdfIcon.png" alt="" class="doc__logo">
                        <p class="doc__link"><a href="/assets/docs/Plan_rab_BPOO.pdf">План работы БПОО</a></p>
                    </div>
                </div>
                <!-- doc3 -->
            </div>
