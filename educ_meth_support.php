...
<head>
    ...
    <!--  -->
    <title>Учебно-методическое обеспечение инклюзивного образования</title>
</head>
<body>
<header>
...
<div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 main__title">
                <p class="title__main tittle__abiturient">Учебно-методическое обеспечение инклюзивного образования:</p>
            </div>
            <div class="col-md-2 main__docsMenu">
                <ul>
                    ...
                    <li><a href="educ_meth_support.php" class="menu__activeLinkDocs">Учебно-методическое обеспечение инклюзивного образования</a></li>
            ...
            <div class="col-md-10 main__docs ">
                ...
                <div class="docs__doc doc__small">
                    <div class="doc__info">
                        ...
                        <p class="doc__link"><a href="">Адаптированные образовательные программы</a></p>
                    </div>
                </div>
                <!-- doc1 -->
                <!-- doc2 -->
                <div class="docs__doc doc__small">
                    <div class="doc__info">
                        <img src="assets/img/pdfIcon.png" alt="" class="doc__logo">
                        <p class="doc__link"><a href="">Информационные материалы</a></p>
                    </div>
                </div>
                <!-- doc2 -->
                <!-- doc3 -->
                <div class="docs__doc doc__small">
                    <div class="doc__info">
                        <img src="assets/img/pdfIcon.png" alt="" class="doc__logo">
                        <p class="doc__link"><a href="">Повышение квалификации</a></p>
                    </div>
                </div>
                <!-- doc3 -->
            </div>
