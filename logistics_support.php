...
<div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12 main__title">
                <p class="title__main tittle__abiturient">Материально-техническое обеспечение обучающихся с ограниченными возможностями здоровья и инвалидностью</p>
            </div>
            <div class="col-md-2 main__docsMenu">
                <ul>
                    <li><a href="docs.php">Документы</a></li>
                    <li><a href="local_docs.php">Локальные документы</li>
                    <li><a href="logistics_support.php" class="menu__activeLinkDocs">Материально-техническое обеспечение обучающихся с ограниченными возможностями здоровья и инвалидностью</a></li>
            ...
            <div class="col-md-10 main__docs">
                ...
                <div class="docs__doc doc__large">
                    <div class="doc__largeInfo">
                        ...
                        <p class="doc__link"><a href="/assets/docs/Nal_spec_sredstv_obuch_2018.pdf">Наличие специальных технических средств обучения студентов с инвалидностью и ОВЗ коллективного 
                        и индивидуального пользования</a></p>
                    </div>
                </div>
                <!-- doc1 -->
                <!-- doc2 -->
                <div class="docs__doc doc__large">
                    <div class="doc__largeInfo">
                        <img src="assets/img/pdfIcon.png" alt="" class="doc__logo">
                        <p class="doc__link"><a href="/assets/docs/Spravka_o_nal_spec_usl_2018.pdf">Справка о наличии специальных условий для получения образования 
                        обучающимися с ограниченными возможностями здоровья</a></p>
                    </div>
                </div>
                <!-- doc2 -->
            </div>
